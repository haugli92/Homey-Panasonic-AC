...
/**
 * Panasonic DKE IR encoder.
 *
 * Faithful port of the Panasonic A/C "DKE" protocol as implemented in
 * IRremoteESP8266 (src/ir_Panasonic.cpp / .h). Builds the full 27-byte
 * state frame and renders it as a Pronto HEX string suitable for Homey's
 * built-in IR blaster (this.homey.rf.getSignalInfrared().cmd()).
 *
...
const MODE = { AUTO: 0, DRY: 2, COOL: 3, HEAT: 4, FAN: 6 };
const FAN = { AUTO: 7, MIN: 0, LOW: 1, MED: 2, HIGH: 3, MAX: 4 };
const FAN_DELTA = 3;
 ...
 */
function buildState({ power, mode, temp, fan }) {
